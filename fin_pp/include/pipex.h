...
void			setting_cmd(char **cmd_path,
								int argc, char **argv, char **envp);
int				ft_pipex(char ***cmd_arr,
								char **envp, int file1_fd, int file2_fd);
...
char			**set_inner_cmd_sp(char **in_cmd_arr,
										char *argv, int cmd_op_count);
